...
webtalk_add_data -client project -key date_generated -value "Fri Mar 10 09:13:32 2017" -context "software_version_and_target_device"
...
webtalk_transmit -clientid 3085774309 -regid "" -xml G:/1-/cpu-run2/cpu2.hw/webtalk/usage_statistics_ext_labtool.xml -html G:/1-/cpu-run2/cpu2.hw/webtalk/usage_statistics_ext_labtool.html -wdm G:/1-/cpu-run2/cpu2.hw/webtalk/usage_statistics_ext_labtool.wdm -intro "<H3>LABTOOL Usage Report</H3><BR>"
webtalk_terminate
