...
set rc [catch {
  ...
  set_property ip_repo_paths g:/1-/cpu-run/cpu2.cache/ip [current_project]
  set_property ip_output_repo g:/1-/cpu-run/cpu2.cache/ip [current_project]
  add_files -quiet G:/1-/cpu-run/cpu2.runs/synth_1/main.dcp
